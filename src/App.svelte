...
html{font-size:100%}
body{margin:0;padding:20px;font-family:Arial,Helvetica,sans-serif;font-size:1rem;color:#fff}
...
.content{flex:1;background:#129a22}.sidebar{flex:0 1 300px;background:#673ab7}
